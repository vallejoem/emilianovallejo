...
agregar.addEventListener("click", function(){
    ...
    divRow.appendChild(elementoDiv);
    elementoDiv.setAttribute("class", " col-4 text-white text-center py-1 border-end border-white items");
    elementoDiv1.appendChild(btn);
    divRow.appendChild(elementoDiv1);
    elementoDiv1.setAttribute("class", " col-4 text-center py-1 items");
    ...
    divAll[8].setAttribute('class', 'bg-primary-subtle col-4 text-primary-emphasis text-center py-1 border-end border-white items');
    divAll[9].setAttribute('class', 'bg-primary-subtle col-4 text-primary-emphasis text-center py-1 border-end border-white items');
    divAll[10].setAttribute('class', 'bg-primary-border-subtle col-4 text-primary-emphasis text-center py-1 border-end border-white items');
    divAll[11].setAttribute('class', 'bg-primary-border-subtle col-4 text-primary-emphasis text-center py-1 border-end border-white items');
